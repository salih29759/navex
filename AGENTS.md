# AGENTS.md — Navex Capital website
...
## Coordinating with another agent (Claude Code)
This repo may be worked by Claude Code in parallel (it reads `CLAUDE.md`, which mirrors this file). Use git;
